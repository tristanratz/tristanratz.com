...
export const retrieveImprint = ():React.ReactElement | undefined => (
    <div>
        ...
        <p>
            ...
            <br/>
            Verbraucher haben die Möglichkeit, Beschwerden an die Online Streitbeilegungsplattform der Europäischen Kommission unter http://ec.europa.eu/odr?tid=321173233 zu richten. Die dafür notwendigen Kontaktdaten finden Sie oberhalb in unserem Impressum.
            <br/><br/>
        ...
        <p>
            ...
            <li>Tristan Ratz</li>
            <li><a href="https://ionicons.com/">Ionic Icons</a></li>
            <li><a href="https://github.com/ant-design/ant-design-icons">Ant Design Icons</a></li>
        </p>
        <h1>Datenschutzerklärung</h1>
        <h2>Datenschutz</h2>
        <p>
            Wir haben diese Datenschutzerklärung (Fassung 01.05.2020-321173233) verfasst, um Ihnen gemäß der Vorgaben der Datenschutz-Grundverordnung (EU) 2016/679 zu erklären, welche Informationen wir sammeln, wie wir Daten verwenden und welche Entscheidungsmöglichkeiten Sie als Besucher dieser Webseite haben.
            <br/><br/>
